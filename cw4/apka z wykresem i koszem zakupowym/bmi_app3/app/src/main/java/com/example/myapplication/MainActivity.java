...
// obsluga przycisku do listy zakupow
        Button btnOpenShopping = findViewById(R.id.btnOpenShopping);
        btnOpenShopping.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        // obsluga przycisku wykresu
        Button btnOpenBmiChart = findViewById(R.id.openBmiChart);
        btnOpenBmiChart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
